...
public class EmployeeResource {
    ...
    private final DummyDB employeeRepository = new DummyDB();
    ...
    public Response insert(Employee employee) {
        ...
        if (rs != null) {
            ...
            return Response.status(Response.Status.BAD_REQUEST).entity("Failed to add employee via PUT request").build();
    }
